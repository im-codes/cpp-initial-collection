...
int main(){
	...
	do{	
		...
		long long harga_barang,jumlah_barang,beli,diskon,total_bayar;				
		...
		cout<<"  Harga Barang        : Rp "; cin>>harga_barang;	 // Input Harga Satuan Barang
		cout<<"  Jumlah Barang       :    "; cin>>jumlah_barang; // Input Jumlah Barang
		cout<<"\n";
		...
		cout<<"  Total Harga Awal    : Rp "<<format_rupiah(beli)<<endl;	// Mencetak Harga Pembayaran 
		cout<<"  Potongan Diskon"<<persen_diskon<<" : Rp "<<format_rupiah(diskon)<<endl; // Mencetak Diskon  
		cout<<"  Total Harga Bayar   : Rp "<<format_rupiah(total_bayar)<<endl<<endl; // Mencetak Total Harga Pembayaran 
