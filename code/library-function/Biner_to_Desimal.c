...
int main(){
	...
	printf("Program Pengubah Bilangan Biner ke Bilangan Desimal menggunakan\nFungsi Pow() pada Library Math\n\n");
  
	printf("Bilangan Biner   : "); scanf("%d", &bilangan_biner);
	...
	printf("Bilangan Desimal :  %d", bilangan_desimal);		// Mencetak bilangan desimal
