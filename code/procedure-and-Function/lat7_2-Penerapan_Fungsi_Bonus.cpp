...
void header(){
	cout<<endl;
			cout<<setw(66)<<"Implementasi atau Penerapan Fungsi - Bonus pelanggan\n";
...
int pilih_bonus(int total_akhir){
	int bonus=0;
	if(total_akhir>=100000 && total_akhir<200000){
		bonus=1;													
	}
	else if(total_akhir>=200000 && total_akhir<300000){
		bonus=2;
					
	}
	else if(total_akhir>=300000 && total_akhir<400000){
		bonus=3;
	}
	else if(total_akhir>=400000 && total_akhir<500000){
		bonus=4;			
	}
	else if(total_akhir>=500000){
		bonus=5;		
	}
	else{
		bonus=6;			
...
int main(){
	...
	do{	
		...
		// Input Jumlah Barang
		cout<<" Subtotal Pembelian   : Rp"; cin>>total; 
		cout<<"\n";
...
Setelah Subtotal Pembelian Pelanggan dimasukkan dengan nilai Pembayaran, perintah switch akan memanggil fungsi pilih_bonus untuk menentukan kode bonus berdasarkan Subtotal pembelian
pelanggan dan kemudian fungsi pilih_bonus akan mengembalikan nilai yang berupa kode bonus kepada perintah switch. pada saat switch sudah mengetahui kode bonusnya,
switch akan menentukan bonus apa yang didapat oleh pelanggan berdasarkan kode bonus yang didapat dari fungsi pilih_bonus sesuai Subtotalnya.
