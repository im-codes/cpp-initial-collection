...
{	//deklarasi variabel 
	...
	//perbandingan ada pada awal pengulangan
	while(bottom<=top && Data[mid]!=x)
	{	
	...
	if(Data[mid]==x)return mid;//jika ditemukan, return i
...
void header(){
	cout<<endl;
			...
			cout<<setw(54.5)<<"Binary Search  - Descending\n";
